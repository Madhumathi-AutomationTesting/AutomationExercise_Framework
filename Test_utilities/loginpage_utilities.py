...
class LoginPageActions:
    def __init__(self):
        self.loginlocators = LoginPageLocators()  # created a variable for locator class
    ...
    def set_username(self):
        """
        find the webelement for username,clear the text field and set the username
        :return:
        """
    ...
    def set_password(self):
        """
        find the webelement for username,clear the text field and set the password
        :return:
        """
